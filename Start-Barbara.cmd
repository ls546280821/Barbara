@echo off
rem ===========================================================================
rem  Start-Barbara.cmd  --  double-click this to launch Barbara.
rem
...
rem  bogus "file not found". The Chinese messages live in Start-Barbara.ps1.
rem ===========================================================================
...
:nops1
echo ==========================================================
echo  [ERROR] Start-Barbara.ps1 was not found next to this file.
