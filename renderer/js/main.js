...
const PACE_MODES = {
  step: {
    ...
    text:
      ...
      '\n' +
      '不要做的事：\n' +
      '  · 不要重述已经写过的局面 —— 换几个词再讲一遍同样的僵局，等于原地不动\n' +
      '  · 不要连续两轮都用「都在等你表态」收尾\n' +
      '  · 不要替玩家决定、不要替玩家说话（玩家的输入是意图，不是授权）\n' +
      '  · 不要在对峙里替玩家了结：不让对手突然离场或摊牌，\n' +
      '    不让别的 NPC 接管玩家正在进行的互动\n' +
      '  · 不要主动引入玩家没提到的新角色或新事件\n' +
      '  · 不要在一轮里把「过程型」的情节走完（一局游戏、一场谈判、一次赶路）——\n' +
      '    只写到开场，后面的每一手留给玩家\n' +
      '\n' +
      '反过来，这几件必须做到：\n' +
      '  · 玩家已经明确要过、已经点头的事 —— 直接做到位，不要回头问「可以吗」。\n' +
      '    （他说「我要他们三个一起」，就是让你安排三个人，不是让你问他「谁先」。）\n' +
      '  · NPC 之间的先后、分工、争执 —— 由你安排，不要抛给玩家决定\n' +
      '  · 玩家的话有点模糊 —— 按最自然的理解推进，\n' +
      '    缺的细节（位置、顺序、衣物）你自己补，不要反问他「到底要哪个」\n' +
      '  · 每轮结尾停在一个需要玩家拍板的地方 —— 但确实还有事要他拍板才停；\n' +
      '    他拍过的就别再问第二遍'
  },
  brisk: {
    label: '快节奏',
