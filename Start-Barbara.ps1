# ============================================================================
#  Start-Barbara.ps1  --  Barbara launcher
#
#  HOW TO RUN
#     double-click  Start-Barbara.cmd      <- recommended
#     or, in an open console:  Start-Barbara.cmd
#
#  ============================ IMPORTANT ====================================
...
try { $Host.UI.RawUI.WindowTitle = 'Barbara' } catch { }
...
$M = @{
  ...
  'STARTING'       = 'Starting Barbara ...'
  'STARTING_1'     = '(This console window is Barbara log output. Do NOT close it -'
  'STARTING_2'     = ' closing it also shuts Barbara down.)'
  'EXIT_ERR'       = '[ERROR] Barbara exited with code {CODE}.'
  'EXIT_TIPS'      = 'For a more detailed error, run these in this folder:'
  'EXIT_TIPS_1'    = '    set BARBARA_OPEN_DEVTOOLS=1'
  'EXIT_TIPS_2'    = '    npm start'
  'EXIT_TIPS_3'    = 'Then send the red errors from the DevTools Console panel.'
  'EXIT_OK'        = 'Barbara closed normally.'
